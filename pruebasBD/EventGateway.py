...
class EventGateway:
	def __init__(self, id ="", organizerId ="", title ="", horaf ="", horai ="",fechaf ="",fechai ="",precio="",pic ="",ciudad="",categoria="", destacado = False, descripcion = "", url = "", nreports = 0, valoration=""):
